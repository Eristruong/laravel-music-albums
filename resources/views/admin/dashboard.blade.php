                    ...
                    <div class="col-xl-3 col-md-3 mb-3">
                      <div class="card rounded-o text-white bg-primary o-hidden h-100">
                        <div class="card-body">
                          ...
                          <div class="mr-5">Đang có {{ App\Models\Music::count() }} bài hát</div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-3 mb-3">
                      <div class="card rounded-0 bg-primary text-white o-hidden h-100">
                        <div class="card-body">
                          ...
                          <div class="mr-5">Đang có {{ App\Models\Album::count() }} Albums</div>
                        </div>
